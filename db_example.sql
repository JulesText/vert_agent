...
INSERT INTO `tactics` (`tactic_id`, `strategy_id`, `status`, `refresh`, `currency`, `action_time_limit`, `condition_time_test`, `condition_time`, `condition_tactic_test`, `condition_tactic`, `condition_pair_test`, `condition_pair_id`, `condition_pair_currency_min`, `condition_pair_indicator`, `condition_pair_value_operand`, `condition_pair_value`, `action`, `exchange`, `pair`, `from_asset`, `from_amount`, `from_percent`, `to_asset`, `trade_price`, `to_fee_max`, `transaction_id`) VALUES
